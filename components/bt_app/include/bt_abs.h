...
bt_state_t bt_set_role(UINT8 is_phone);
...
bt_status_t bt_hfp_callback_register_v2(bt_hfp_cb_t *cb);

bt_status_t bt_hfp_connect_v2(bdaddr_t *pAddr, UINT32 timeout, void (*cb)(bt_conn_t *));

bt_status_t bt_hfp_disconnect_v2(bt_conn_t *hfp_conn);

bt_status_t bt_hfp_audio_switch_v2(bt_conn_t *hfp_conn);

bt_status_t bt_hfp_audio_switch_v2(bt_conn_t *hfp_conn);

bt_status_t bt_hfp_call_num_v2(bt_conn_t *hfp_conn, UINT8 *call_num);

bt_status_t bt_hfp_adjust_vol_v2(bt_conn_t *hfp_conn, UINT8 type, UINT8 vol);

bt_status_t bt_hfp_send_ciev_v2(bt_conn_t *hfp_conn, hfp_cind_t ind, UINT8 value);

bt_status_t bt_hfp_send_raw_data_v2(bt_conn_t *hfp_conn, UINT8 *buff, UINT32 len);

bt_status_t bt_hfp_close_v2(void);

bt_status_t bt_hfp_ring_v2(bt_conn_t *hfp_conn, UINT8 ring);

bt_status_t bt_hfp_set_num_v2(bt_conn_t *hfp_conn, UINT8 *num);
...
avrcp_playback_status_t bt_avrcp_play_state_get(void);
...
//sdp
bt_status_t bt_sdp_callback_register(btsdp_callbacks_t *callbacks);
...
bt_status_t bt_a2dp_connect_v2(bdaddr_t *pAddr);
bt_status_t bt_a2dp_disconnect_v2(bdaddr_t *pAddr);
bt_status_t bt_a2dp_send_data_v2(bt_a2dp_data_t *a2dp_data);
bt_status_t bt_a2dp_send_signaling_v2(bt_a2dp_signaling_t *a2dp_signaling);
bt_status_t bt_a2dp_callback_register_v2(bt_a2dp_cb_t *callbacks);
bt_status_t bt_avrcp_callback_register_v2(bt_avrcp_cb_t *callbacks);
bt_status_t bt_avrcp_notify_volume_change_v2(bdaddr_t addr);
