...
#include "sci_types.h"
#include "bt_abs.h"
//reconnect function as headset
#define RECONNECTION_EN 0
...
typedef enum
{
    ...
    BT_AUD_A2DP_MSG,     //sink
    BT_AUD_A2DP_MSG_SRC, //source
} BT_AUDIO_MSG_E;
...
int bt_handle_cfw_func(const osiEvent_t *event);

BT_STATUS app_bt_sharkhands_riscv(void);
