...
#define EV_CFW_CC_DTMF_KEY_IND (EV_CFW_IND_BASE + 70)
#define EV_CFW_SMS_CONCAT_MESSAGE_IND (EV_CFW_IND_BASE + 71)
#define EV_CFW_NW_JAMMING_DETECT_V2_IND (EV_CFW_IND_BASE + 72)
#define EV_CFW_NW_EMM_FAILED_PROCEDURE_IND (EV_CFW_IND_BASE + 74)
#define EV_CFW_SMS_CLEAR_UNSOLICITED_RESULT_CODES_IND (EV_CFW_IND_BASE + 75)

#define EV_CFW_NW_REPORT_DISABLE_LTE_IND (EV_CFW_IND_BASE + 92)
...
#define EV_CFW_NW_GET_JAMMING_V2_RSP (EV_CFW_NW_RSP_BASE + 20)
#define EV_CFW_NW_GET_T3245_LENGTH_RSP (EV_CFW_NW_RSP_BASE + 21)
#define EV_CFW_NW_NET_DL_PSM_PARAM_RSP (EV_CFW_NW_RSP_BASE + 22)
...
#define EV_TCPIP_CFW_GPRS_ACTED (EV_CFW_GPRS_RSP_BASE + 11)
#define EV_TCPIP_CFW_GPRS_DEACTED (EV_CFW_GPRS_RSP_BASE + 12)
#define EV_TCPIP_CFW_GPRS_IPV6_PREFERED (EV_CFW_GPRS_RSP_BASE + 13)
//
// CC Response Event
//
