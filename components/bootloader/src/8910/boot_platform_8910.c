...
void bootResetPinEnable(void)
{
    ...
    //Switch on each power should be careful,
    //otherwise it will cause system exception.
    REG_RDA2720M_GLOBAL_SWRST_CTRL1_T swrst_ctrl1 = {};
    swrst_ctrl1.b.sw_rst_vio18_pd_en = 0;
    swrst_ctrl1.b.sw_rst_ddr12_pd_en = 0;
    swrst_ctrl1.b.sw_rst_mmc_pd_en = 0;
    swrst_ctrl1.b.sw_rst_usb33_pd_en = 0;
    swrst_ctrl1.b.sw_rst_rf15_pd_en = 0;
    swrst_ctrl1.b.sw_rst_ana_pd_en = 0;
    swrst_ctrl1.b.sw_rst_vdd28_pd_en = 0;
