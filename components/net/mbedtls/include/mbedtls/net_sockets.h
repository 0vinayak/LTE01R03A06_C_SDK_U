...
#if (defined(CONFIG_QUEC_PROJECT_FEATURE_QTHSDK)||defined(QL_APP_FEATURE_QCLOUD_IOT)||(defined(CONFIG_QUEC_PROJECT_FEATURE_DMHTTP) && (defined(__QUEC_OEM_VER_OPC__)||defined(__QUEC_OEM_VER_BUX__))))
