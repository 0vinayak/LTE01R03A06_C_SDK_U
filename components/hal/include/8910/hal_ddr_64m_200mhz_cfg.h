...
static inline void prvRamPhyPadCfg(void)
{
    ...
    hwp_lpddrPhy->lpddr_rf_cfg_dll_dl_0_wr_ac = 0x38;  //! ac line edge
    hwp_lpddrPhy->lpddr_rf_cfg_dll_dl_0_wr_ds0 = 0x37; //! output edge
    hwp_lpddrPhy->lpddr_rf_cfg_dll_dl_1_wr_ds0 = 0x2d; //! input pos edge
    hwp_lpddrPhy->lpddr_rf_cfg_dll_dl_2_wr_ds0 = 0x2d; //! input neg edge
    hwp_lpddrPhy->lpddr_rf_cfg_dll_dl_3_wr_ds0 = 0x37; //! gate edge
    hwp_lpddrPhy->lpddr_rf_cfg_dll_dl_0_wr_ds1 = 0x37; //! outupt edge
    hwp_lpddrPhy->lpddr_rf_cfg_dll_dl_1_wr_ds1 = 0x2d; //! input pos edge
    hwp_lpddrPhy->lpddr_rf_cfg_dll_dl_2_wr_ds1 = 0x2d; //! input neg edge
    hwp_lpddrPhy->lpddr_rf_cfg_dll_dl_3_wr_ds1 = 0x37; //! gate edge
    ...
    hwp_lpddrPhy->lpddr_drf_cfg_data_ie_sel_f0 = 0x7f;  //!
...
static inline void prvRamDmcCfg(void)
{
    ...
    hwp_dmcCtrl->address_control = 0x20202;   // 10_COL_BITS, 13_ROW_BITS, 2_BANK_BITS_4BK, 0_CHIP_BITS_1CS, 0_CHANNEL_BITS_1MEMIF
    hwp_dmcCtrl->decode_control = 0x12;       // CHIP_BANK_ROW_CHANNEL_COL, PAGE_ADDR_12_11
    hwp_dmcCtrl->t_mrr = 0x2;
    hwp_dmcCtrl->t_mrw = 0x5;
    hwp_dmcCtrl->t_xsr = 0x1c001c;
    hwp_dmcCtrl->t_rddata_en = 0x2;
    hwp_dmcCtrl->t_phywrlat = 0x101;
    hwp_dmcCtrl->t_rcd = 0x3;
    hwp_dmcCtrl->t_refi = 0xc3;
    hwp_dmcCtrl->t_rfc = 0x120012;
...
static inline void prvRamBootCfg(void)
{
    ...
    hwp_dmcCtrl->direct_cmd = 0x10000102; //! MR2, RL=3, WL=1, LPDDR2-400
