...
typedef enum{
	...
	HTTP_CLIENT_OPT_SSL_SNI,
	HTTP_CLIENT_OPT_SSL_VERSION,
	HTTP_CLIENT_OPT_SSL_HS_TIMEOUT,
	HTTP_CLIENT_OPT_SSL_IGNORE_LOCALTM,
	HTTP_CLIENT_OPT_SSL_IGNORE_INVALID_CERT_SIGN,
	HTTP_CLIENT_OPT_SSL_IGNORE_CERT_ITEM,
	HTTP_CLIENT_OPT_SSL_IGNORE_MULTI_CERTCHAIN_VERIFY,
	HTTP_CLIENT_OPT_RAW_REQUEST,
	HTTP_CLIENT_OPT_RAW_FILE,
}http_option_e;
