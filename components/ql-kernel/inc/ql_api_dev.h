...
/*
* to get the cp version, maximum support 64 bytes.
*/
ql_errcode_dev_e ql_dev_get_cp_version(char* cp_version, uint8_t *len);
/*
...
* to get wdt cfg
*/
ql_errcode_dev_e ql_dev_get_wdt_cfg(uint8_t *opt);
