...
/*****************************************************************
* Function: ql_bt_hfp_ag_init
*
* Description:
*   初始化BT HFP AG并注册回调函数。初始化会设置BT的mac地址
* 
* Parameters:
*   bt_cb           [in]    回调函数
*
...
*
*****************************************************************/
ql_errcode_bt_e ql_bt_hfp_ag_init(ql_bt_callback bt_cb);

/*****************************************************************
* Function: ql_bt_hfp_ag_release
*
* Description:
*   BT HFP AG释放资源
* 
...
*
*****************************************************************/
ql_errcode_bt_e ql_bt_hfp_ag_release();

/*****************************************************************
* Function: ql_bt_hfp_ag_dial
*
* Description:
*   拨打电话
* 
...
*
*****************************************************************/
ql_errcode_bt_e ql_bt_hfp_ag_dial(UINT8 *num);
