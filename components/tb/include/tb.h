...
typedef struct
{
    char provider_long_name[TB_PROVIDER_LONG_NAME_SIZE + 1];
    char provider_short_name[TB_PROVIDER_SHORT_NAME_SIZE + 1];
...
// SMS module
#define TB_SUPPORT_CONCAT_MESSAGE
...
//Other
extern bool tb_sys_setNatCfg(int value);
extern bool tb_sys_getNatCfg(int *pValue);
