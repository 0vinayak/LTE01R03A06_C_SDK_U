...
ql_errcode_bt_e ql_ble_gatt_demo_add_service(int idx)
{
    ...
    case 1:
        ...
        ql_ble_gatt_add_service(0x01, uuid, 0);
        break;
...
ql_errcode_bt_e ql_ble_gatt_demo_add_chara_value(int idx)
{
    ...
    /********************Data of all the first service characteristics go here in case 0*/
    case 0:
        uuidlive =
            (ql_ble_gatt_uuid_s){
                .uuid_type = 1,
        ...
        ql_ble_gatt_add_chara_value(0x01, 0x01, QL_ATT_PM_READABLE | QL_ATT_PM_WRITEABLE, uuidlive, sizeof(Live_Data.lds), (unsigned char *)&Live_Data.lds[0]);
...
ql_errcode_bt_e ql_ble_demo_send_data()
{
    ...
    QL_BLE_GATT_LOG("Live data%s", Live_Data.lds);
